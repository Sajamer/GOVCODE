...
import { deleteComplianceById } from '@/lib/actions/kpi-dimensions/compliance.actions'
import { deleteObjectiveById } from '@/lib/actions/kpi-dimensions/objective.actions'
import { deleteProcessById } from '@/lib/actions/kpi-dimensions/process.actions'
